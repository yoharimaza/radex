...
//
//     final nationalDex = nationalDexFromJson(jsonString);

import 'dart:convert';

NationalDex nationalDexFromJson(String str) => NationalDex.fromJson(json.decode(str));

String nationalDexToJson(NationalDex data) => json.encode(data.toJson());
...
class NationalDex {
  ...
  factory NationalDex.fromJson(Map<String, dynamic> json) => NationalDex(
    ...
    pokemonEntries: List<PokemonEntry>.from(json["pokemon_entries"].map((x) => PokemonEntry.fromJson(x))),
    region: json["region"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "pokemon_entries": List<dynamic>.from(pokemonEntries.map((x) => x.toJson())),
    "region": region,
